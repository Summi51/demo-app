...
export default function Ticker() {
  ...
  return (
    <section className="w-full bg-white relative border-b border-gray-100 overflow-hidden">
      {/* 
        Matches Figma specs precisely: 
        Frame Width: 1928px, Height: 150px layout 
      */}
      <div className="max-w-[1928px] mx-auto w-full flex flex-col xl:flex-row relative px-6 md:px-[60px] xl:pl-[93px] xl:pr-[40px] pb-10 pt-8 xl:pt-[50px] xl:pb-[15px] h-auto min-h-[150px]">
        ...
        {/* Figma Properties Applied -> Width: 206px, Height: 49px, Top: 50px, Left: 93px, Color: #FF7300, Radius: 6px */}
        ...
        {/* The 4 Text Blocks 
            Using a Grid ensures all 4 items render natively responsive without shrinking/overflow clipping.
        */}
          ...
          {topics.map((text, idx) => (
            <div key={idx} className="flex flex-col justify-between relative group cursor-pointer h-full min-h-[100px] xl:min-h-0">
              ...
              <div className="flex flex-col">
                {/* Blue line - perfectly tracking the exact top pixel of the title */}
              ...
              {/* Arrow -> anchored relative to the text component */}
